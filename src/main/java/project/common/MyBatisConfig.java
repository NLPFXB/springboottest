...
import project.datasource.DynamicDataSource;
...
@MapperScan(basePackages = "project.mapper")
public class MyBatisConfig {
    ...
    public DynamicDataSource dataSource(@Qualifier("myTestDbDataSource") DataSource myTestDbDataSource,
        ...
        targetDataSources.put(DatabaseType.db1, myTestDbDataSource);
        targetDataSources.put(DatabaseType.db2, myTestDb2DataSource);
